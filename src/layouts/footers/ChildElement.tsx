...
const FooterTwo = () => {
  ...
  const socialIconStyle = {
    ...
    marginBottom: '15px',
    gap: '20px', // Add spacing between social links
  };
    ...
    <footer style={footerStyle}>
      <div className="container">
        <div className="inner-wrapper">
          <div className="row justify-content-between">
            <div className="col-xl-4 col-lg-3 footer-intro mb-15">
              <div className="logo mb-25" style={logoStyle}>
                <Link href="/" className="d-flex align-items-center">
                <Image
                    src={logo}
                    alt="logo"
              ...
              <a href="mailto:jobisupport@new.com" className="email fw-500" style={emailStyle}>jobisupport@new.com</a>
              <Image src={shape} alt="decorative shape" className="lazy-img" style={shapeStyle} />
            </div>
            {/* Widget One */}
            <WidgetOne cls='col-lg-2 col-sm-4' />
            {/* Widget Two */}
      ...
      <div className="bottom-footer" style={bottomFooterStyle}>
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-4 order-lg-3 mb-15">
              <ul className="style-none d-flex order-lg-last justify-content-center justify-content-lg-end social-icon" style={socialIconStyle}>
                <SocialLinks />
              </ul>
            </div>
            <div className="col-lg-4 order-lg-1 mb-15">
              <ul className="d-flex style-none bottom-nav justify-content-center justify-content-lg-start" style={bottomNavStyle}>
                <li style={bottomNavItemStyle}><Link href='/privacy'>Privacy & Terms.</Link></li>
                <li style={bottomNavItemStyle}><Link href='/contact'>Contact Us</Link></li>
              </ul>
            </div>
            <div className="col-lg-4 order-lg-2 text-center">
              <p className="mb-15">
                Copyright ©2024 <a href="https://www.goanny.com" target="_blank" rel="noopener noreferrer" style={{ color: '#fff', textDecoration: 'underline' }}>Goanny</a>. All rights reserved.
              </p>
            </div>
          </div>
        </div>
