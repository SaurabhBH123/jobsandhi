...
// internal
import image_02 from '@/assets/images/assets/men3.jpg';
import image_03 from '@/assets/images/assets/men5.jpg';
import image_04 from '@/assets/images/assets/men4.jpg';
						...
						<div className="col-lg-7 col-md-8 m-auto order-lg-first">
							<div className="img-data position-relative me-xl-5 md-mt-20">
								<div className="row align-items-center gx-xl-5">
									<div className="col-6">
										<Image src={image_02} alt="image" className="lazy-img mt-35 md-mt-20 wow fadeInLeft img" />
									</div>
									<div className="col-6">
										<Image src={image_03} alt="image" className="lazy-img mt-35 md-mt-20 wow fadeInDown img" />

										<Image src={image_04} alt="image" className="lazy-img mt-35 md-mt-20 wow fadeInUp img" />
									</div>
								</div>
